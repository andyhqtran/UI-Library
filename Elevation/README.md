...
2. Now with the repo cloned, you can navigate to it using the following command: `cd UI-Library/Elevation`.
...
3. With grunt running, you can head over to `localhost:3000` to view to `Elevation`.